...
def test(loader, net, file):
    ...
    file.write('[Evaluate] Average loss: {:.4f}, Accuracy: {}/{} ({:.2f}%)\n'.format(
        test_loss, correct, N, 100. * correct / N))
    return (100. * correct / N)


def load_and_test_net(data, datadir, weights, model, num_cls, file,
